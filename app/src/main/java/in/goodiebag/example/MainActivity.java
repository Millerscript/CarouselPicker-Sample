...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageItems.add(new CarouselPicker.DrawableItem(R.drawable.img1));
        imageItems.add(new CarouselPicker.DrawableItem(R.drawable.img2));
        imageItems.add(new CarouselPicker.DrawableItem(R.drawable.img3));
